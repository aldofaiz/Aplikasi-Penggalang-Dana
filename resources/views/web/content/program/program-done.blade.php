@extends('web.app', ['title' => 'Program Terlaksana'])

@section('content')
<div class="container">
    <!-- Program Terlaksana -->
    <div class="row"> 
        <h1 class="fw-bold text-center mt-5">Program Terlaksana</h1>
    </div>
    <div class="row">  
        @forelse($programs_done as $program)
            ...
            <div class="card-deck d-flex justify-content-center">        
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <a href="{{ url("/program/{$program->id}") }}" class="btn btn-primary">Lihat Program</a>
                    </div>
                </div>
        ...
        <div class="card-deck d-flex justify-content-center">
            <div class="p-5">
                <div class="p-4">
                    <h5 class="mt-3 mb-5 p-5">Tidak Ada Program Terlaksana Saat ini</h5>
                </div>
            </div>
        </div>
        @endforelse 
